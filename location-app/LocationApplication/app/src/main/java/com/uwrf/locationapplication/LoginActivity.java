...
public class LoginActivity extends Activity {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, HttpResponse> {
        ...
        protected HttpResponse doInBackground(Void... params) {
            ...
            String url = Configs.protocol + "://" + Configs.host + ":" + Configs.port + "/" + Configs.service;
        ...
        protected void onPostExecute(final HttpResponse response) {
            ...
            if (response != null) {
                if (response.getStatusLine().getStatusCode() == 403) {
                    mEmailView.setError(getString(R.string.error_access_denied));
                    mPasswordView.setError(getString(R.string.error_access_denied));
                    ...
                    Intent intent = new Intent(currentActivity, OptionsActivity.class);
                ...
                mEmailView.setError(getString(R.string.error_server_not_reachable));
                mPasswordView.setError(getString(R.string.error_server_not_reachable));
                mEmailView.requestFocus();
            }
        }
